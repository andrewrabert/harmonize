...
class TestApp(unittest.TestCase):
    ...
    def test_copies_other_file_type(self):
        ...
        self.assertEqual(text_file.read_text(), (target_dir / "other.txt").read_text())
    ...
    def test_multiple_mixed_audio_and_other_files(self):
        ...
        for duration in range(1, 4):
            helpers.ffmpeg.generate_silence(duration, source_dir / f"{duration}.flac")
        ...
        self.assertEqual(stderr[0:2], [f'Scanning "{source_dir}"', "Scanned 4 items"])
        self.assertEqual(
            sorted(stderr[2:6]),
            [
        ...
        self.assertEqual(stderr[6], "Processing complete")
